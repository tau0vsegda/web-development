...
function drawHeadCartmanland(person) {
  person.beginPath();
  person.fillStyle = "#ffeac1";
...
function drawCapCartmanland(person) {
  person.beginPath();
...
function drawBodyCartmanland(person) {
  person.beginPath();
...
function drawHandsCartmanland(person) {
  person.beginPath();
  person.fillStyle = "#ffe018";
...
function drawHandsKenny(person) {
  person.beginPath();
...
function drawFeetCartmanland(person) {
  person.beginPath();
...
function drawCartmanland() {
  const canvas = document.getElementById('Cartmanland');
  const Cartmanland = canvas.getContext('2d');
  drawLegs(Cartmanland, 60, 359, 74, 399, 328, 399, 341, 359, "#804429");
  drawFeetCartmanland(Cartmanland);
  drawBodyCartmanland(Cartmanland);
  drawHeadCartmanland(Cartmanland);
  drawDoubleChin(Cartmanland);
  drawCapCartmanland(Cartmanland);
  drawMouth(Cartmanland);
  drawEyes(Cartmanland, 174, 198, 240, 199, 38, 32, Math.PI*2/3, Math.PI*3/8, 186, 195, 225, 196, 3);
  drawHandsCartmanland(Cartmanland);
  
}

function drawKenny() {
  const canvas = document.getElementById('Kenny');
  const Kenny = canvas.getContext('2d');
  
  drawLegs(Kenny, 130, 371, 130, 400, 269, 400, 270, 371, "#f46600");
  drawFeetKenny(Kenny);
  drawBodyKenny(Kenny);
  drawHoodKenny(Kenny);
  drawHeadKenny(Kenny);
  drawEyes(Kenny, 169, 194, 229, 199, 33, 30, Math.PI*2/3, Math.PI*5/12, 178, 193, 220, 196, 4);
  drawHairKenny(Kenny);jkq16666666666666666666 
  drawHandsKenny(Kenny);
  }
